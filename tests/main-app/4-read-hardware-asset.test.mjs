import { INSERTED_ASSET_ID } from "./3-create-hardware-asset.test.mjs";
...
export default async (page) => new Promise(async (resolve, reject) => {
    try {
        ...
        const ASSET_ID = INSERTED_ASSET_ID;
        if(!ASSET_ID) return reject('Unable to execute. Previous asset not inserted.')
